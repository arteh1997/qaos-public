          ...
          <div className="prose prose-neutral prose-invert max-w-none space-y-8">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing or using Qaos (&quot;the Service&quot;), you agree
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Qaos provides a cloud-based inventory management platform that
                enables users to track inventory, manage shifts, generate
                reports, and oversee multi-location operations. The Service is
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                The Service is offered on a subscription basis at £299 per store
                per month. By subscribing, you agree to:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li>
                  Pay the applicable subscription fees for your selected plan
                </li>
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                We offer a 1-month free trial for new accounts. No payment is
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                period. We do not provide refunds for partial months or unused
                time. After cancellation, your data will be retained for 30 days
                before permanent deletion, during which time you may export your
                data.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                You retain all rights to the data you upload to the Service. We
                do not claim ownership of your content. You grant us a limited
                license to use, store, and process your data solely for the
                purpose of providing the Service. We will not sell, share, or
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                do not guarantee uninterrupted access and may occasionally need
                to perform maintenance or updates. We will endeavour to provide
                advance notice of planned maintenance. We are not liable for any
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                To the maximum extent permitted by law, Qaos shall not be liable
                for any indirect, incidental, special, consequential, or
                punitive damages, including but not limited to loss of profits,
                data, or business opportunities. Our total liability shall not
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                You agree to indemnify and hold harmless Qaos, its officers,
