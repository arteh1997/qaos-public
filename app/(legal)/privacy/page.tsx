          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                ...
                <li><strong>Cookies:</strong> Session and preference data (see our Cookie Policy for details)</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                including encryption in transit (TLS/SSL), encryption at rest, regular security assessments, access
                controls, and secure data centres. However, no method of transmission over the internet is 100% secure,
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                Service. After account deletion, we retain certain data for up to 30 days to allow for data recovery.
