          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                to website owners. Cookies help us provide you with a better experience by enabling us to monitor which
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                ...
                <li><strong>Preferences:</strong> To remember your settings and preferences (e.g., theme, language)</li>
                <li><strong>Security:</strong> To protect against fraudulent activity and ensure data integrity</li>
              ...
              <div className="mt-6 space-y-6">
                <div className="p-4 bg-muted/30 rounded-lg">
                  ...
                  <p className="text-muted-foreground text-sm mb-2">
                    These cookies are necessary for the Service to function and cannot be switched off. They are
                    usually set in response to actions you take, such as logging in or filling in forms.
                  </p>
                  <div className="mt-3 border-t border-border/40 pt-3">
                    <div className="grid grid-cols-3 gap-2 text-sm">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">Session / 7 days</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4 bg-muted/30 rounded-lg">
                  ...
                  <p className="text-muted-foreground text-sm mb-2">
                    These cookies enable the Service to provide enhanced functionality and personalisation, such as
                    remembering your preferred theme (light or dark mode).
                  </p>
                  <div className="mt-3 border-t border-border/40 pt-3">
                    <div className="grid grid-cols-3 gap-2 text-sm">
                      <div>
                ...
                <div className="p-4 bg-muted/30 rounded-lg">
                  ...
                  <div className="mt-3 border-t border-border/40 pt-3">
                    <div className="grid grid-cols-3 gap-2 text-sm">
                      ...
                      <div>
                        <p className="font-medium text-foreground">Duration</p>
                        <p className="text-muted-foreground">2 years / 24 hours</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section>
              ...
              <h3 className="text-xl font-medium text-foreground mb-3 mt-6">Browser Settings</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
                Most browsers allow you to refuse or accept cookies through their settings. Here&apos;s how to access
              ...
              <h3 className="text-xl font-medium text-foreground mb-3 mt-6">Opt-Out Tools</h3>
              <p className="text-muted-foreground leading-relaxed">
