      ...
      <Card>
        <CardContent className="py-12 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Please select a store from the top of the sidebar to start counting.
          </p>
        </CardContent>
      </Card>
    );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Record today&apos;s inventory counts
          </p>
      ...
      {todayCountCompleted ? (
        <Card className="border-green-500/50 bg-green-500/10">
          <CardContent className="py-4">
            <div className="flex items-center gap-3">
              ...
              <Badge
                variant="outline"
                className="ml-auto border-green-500 text-emerald-400"
              >
                Done
              </Badge>
            </div>
        ...
        <Card className="border-amber-500/40/50 bg-amber-500/10">
          <CardContent className="py-4">
            <div className="flex items-center gap-3">
              <AlertTriangle className="h-5 w-5 text-yellow-400" />
              <div>
                <p className="font-semibold text-amber-800">
                  Count Not Submitted Yet
                </p>
