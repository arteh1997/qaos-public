...
import { COUNTRY_CURRENCY, getPricingTier, type PricingTier } from '@/lib/stripe/billing-config'
...
const TIMEZONE_TO_COUNTRY: Record<string, string> = {
  ...
  // Middle East
  'Asia/Riyadh': 'SA', 'Asia/Dubai': 'AE', 'Asia/Bahrain': 'BH',
  'Asia/Kuwait': 'KW', 'Asia/Muscat': 'OM', 'Asia/Qatar': 'QA',
  // Asia-Pacific
  ...
  'Asia/Nicosia': 'CY', 'Europe/Zagreb': 'HR',
}
...
const LOCALE_TO_COUNTRY: Record<string, string> = {
  'en-GB': 'GB', 'en-US': 'US', 'en-AU': 'AU', 'en-CA': 'CA', 'en-IN': 'IN',
  'en-NZ': 'NZ', 'en-IE': 'IE',
  'fr-FR': 'FR', 'fr-CA': 'CA', 'fr-BE': 'BE',
  'de-DE': 'DE', 'de-AT': 'AT',
  'es-ES': 'ES', 'it-IT': 'IT', 'nl-NL': 'NL', 'nl-BE': 'BE',
  'pt-PT': 'PT', 'fi-FI': 'FI', 'el-GR': 'GR',
  'ar-SA': 'SA', 'ar-AE': 'AE', 'ar-BH': 'BH', 'ar-KW': 'KW',
  'ar-OM': 'OM', 'ar-QA': 'QA',
  'hi-IN': 'IN',
}
...
export function useCurrencyDetection(): {
  ...
  useEffect(() => {
    ...
    setState({ currencyCode: currency, countryCode: country, isDetected: true })
  }, [])
