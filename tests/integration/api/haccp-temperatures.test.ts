...
describe('HACCP Temperature Logs API', () => {
  ...
  describe('GET /api/stores/[storeId]/haccp/temperature-logs', () => {
    it('should return 401 when not authenticated', async () => {
      ...
      const { GET } = await import('@/app/api/stores/[storeId]/haccp/temperature-logs/route')

      const request = createMockRequest('GET', `/api/stores/${STORE_UUID}/haccp/temperature-logs`)
    ...
    it('should filter by out_of_range_only', async () => {
      ...
      const request = createMockRequest('GET', `/api/stores/${STORE_UUID}/haccp/temperature-logs`, undefined, {
  ...
  describe('POST /api/stores/[storeId]/haccp/temperature-logs', () => {
    it('should return 401 when not authenticated', async () => {
      ...
      const { POST } = await import('@/app/api/stores/[storeId]/haccp/temperature-logs/route')

      const request = createMockRequest('POST', `/api/stores/${STORE_UUID}/haccp/temperature-logs`, {
        location_name: 'Walk-in Fridge',
        temperature_celsius: 4.5,
        min_temp: 2,
        max_temp: 8,
