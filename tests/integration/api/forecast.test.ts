...
describe('Forecast API', () => {
  ...
  describe('GET /api/reports/forecast', () => {
    it('should return 401 when not authenticated', async () => {
      ...
      const request = createMockRequest('GET', '/api/reports/forecast', { store_id: STORE_UUID })
    ...
    it('should return forecast data for Owner', async () => {
      ...
      const inventoryQuery = createChainableMock({
        data: [
          ...
          },
          {
            ...
            par_level: 30,
            unit_cost: 2.0,
            inventory_item: { id: 'item-2', name: 'Lettuce', category: 'Produce', unit_of_measure: 'units', is_active: true },
          },
        ],
        error: null,
      })
      ...
      const stockHistoryQuery = createChainableMock({
        data: [
          { inventory_item_id: 'item-1', action_type: 'Count', quantity_change: -5, created_at: '2026-02-05T10:00:00Z' },
          { inventory_item_id: 'item-1', action_type: 'Count', quantity_change: -3, created_at: '2026-02-06T10:00:00Z' },
          { inventory_item_id: 'item-2', action_type: 'Count', quantity_change: -8, created_at: '2026-02-05T10:00:00Z' },
        ],
        error: null,
      })
