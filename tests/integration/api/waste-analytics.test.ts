...
describe('Waste Analytics API', () => {
  ...
  describe('GET /api/stores/[storeId]/waste-analytics', () => {
    ...
    it('should return 401 when not authenticated', async () => {
      ...
      const { GET } = await import('@/app/api/stores/[storeId]/waste-analytics/route')

      const request = createMockRequest('GET', `/api/stores/${STORE_UUID}/waste-analytics`)
      ...
      const wasteLogQuery = createChainableMock({
        data: [
          ...
          },
          {
            ...
            inventory_item: { id: 'item-2', name: 'Milk', category: 'Dairy', unit_of_measure: 'L' },
          },
          {
            id: 'wl-3',
            store_id: STORE_UUID,
    ...
    it('should accept custom date range', async () => {
      ...
      const request = createMockRequest('GET', `/api/stores/${STORE_UUID}/waste-analytics`, undefined, {
