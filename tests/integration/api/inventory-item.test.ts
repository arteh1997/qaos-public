...
describe('Inventory Item API Tests', () => {
  ...
  describe('GET /api/inventory/:itemId', () => {
    it('should return 401 when not authenticated', async () => {
      ...
      const response = await GET(request, { params: Promise.resolve({ itemId: 'item-123' }) })
  ...
  describe('PATCH /api/inventory/:itemId', () => {
    ...
    it('should return 400 for duplicate name', async () => {
      ...
      const request = createMockRequest('PATCH', { name: 'Existing Item Name' })
      const response = await PATCH(request, { params: Promise.resolve({ itemId: 'item-123' }) })
      const data = await response.json()
  ...
  describe('DELETE /api/inventory/:itemId', () => {
    it('should return 401 when not authenticated', async () => {
      ...
      const response = await DELETE(request, { params: Promise.resolve({ itemId: 'item-123' }) })
      const data = await response.json()
    ...
    it('should return 404 when item not found', async () => {
      ...
      const request = createMockRequest('DELETE')
      const response = await DELETE(request, { params: Promise.resolve({ itemId: 'nonexistent' }) })
      const data = await response.json()
