    ...
    data: [
      {
        ...
        store: { id: STORE_A, name: "Store Alpha", is_active: true },
      },
      {
        id: "su-2",
        store_id: STORE_B,
        ...
        role: "Owner",
        is_billing_owner: true,
        store: { id: STORE_B, name: "Store Beta", is_active: true },
      },
    ],
    error: null,
  });
  ...
  describe("GET /api/reports/benchmark", () => {
    ...
    it("should respect max 10 stores limit", async () => {
      ...
      const ids = Array.from(
        { length: 11 },
        (_, i) => `${String(i).padStart(8, "0")}-0000-4000-a000-000000000000`,
      );
