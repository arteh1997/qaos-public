  ...
  describe('GET /api/shifts', () => {
    ...
    describe('Authorized Requests', () => {
      ...
      it('should filter by store_id', async () => {
        ...
        const request = createMockRequest('GET', undefined, { store_id: 'store-1' })
        const response = await GET(request)
        const data = await response.json()
  ...
  describe('POST /api/shifts', () => {
    ...
    describe('Successful Creation', () => {
      ...
      it('should create shift for Owner', async () => {
        ...
        const insertQuery = createChainableMock({ data: insertResultData, error: null })
        ...
        const shiftsQueryHandler = {
          ...
          then: (resolve: (value: unknown) => unknown) => Promise.resolve(overlapCheckResult).then(resolve),
        }
