...
function setupAuthenticatedUser(role: string, options: { isBillingOwner?: boolean; stores?: object[] } = {}) {
  ...
  describe('POST /api/billing/setup-intent', () => {
    ...
    describe('Successful Setup Intent', () => {
      it('should create setup intent for authenticated user', async () => {
        ...
        const { getOrCreateCustomer, createSetupIntent } = await import('@/lib/stripe/server')
        ...
        } as unknown as ReturnType<typeof createSetupIntent> extends Promise<infer T> ? T : never)
  ...
  describe('GET /api/billing/subscriptions', () => {
    describe('Authentication', () => {
      it('should return 401 when not authenticated', async () => {
        ...
        const request = createMockRequest('GET', '/api/billing/subscriptions', undefined, {
          storeId: 'store-1',
        })
  ...
  describe('POST /api/billing/subscriptions', () => {
    describe('Authentication', () => {
      it('should return 401 when not authenticated', async () => {
        ...
        const request = createMockRequest('POST', '/api/billing/subscriptions', {
          storeId: 'store-1',
