...
describe("Audit Logging", () => {
  ...
  describe("auditLog", () => {
    it("should insert audit log entry", async () => {
      ...
      await auditLog(mockSupabase as unknown as SupabaseClient, entry);
    ...
    it("should extract category from action", async () => {
      ...
      for (const { action, expectedCategory } of actions) {
        ...
        await auditLog(mockSupabase as unknown as SupabaseClient, { action });
    ...
    it("should handle missing optional fields", async () => {
      await auditLog(mockSupabase as unknown as SupabaseClient, {
        action: "auth.login",
      });
    ...
    it("should not throw on insert error", async () => {
      ...
      await expect(
        auditLog(mockSupabase as unknown as SupabaseClient, {
          action: "auth.login",
        }),
  ...
  describe("auditLogBatch", () => {
    it("should insert multiple audit log entries", async () => {
      ...
      await auditLogBatch(mockSupabase as unknown as SupabaseClient, entries);
    ...
    it("should not insert if entries array is empty", async () => {
      await auditLogBatch(mockSupabase as unknown as SupabaseClient, []);
    ...
    it("should not throw on insert error", async () => {
      ...
      await expect(
        auditLogBatch(mockSupabase as unknown as SupabaseClient, [
          { action: "auth.login" },
        ]),
      ).resolves.not.toThrow();
    });
