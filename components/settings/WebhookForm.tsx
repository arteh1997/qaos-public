...
interface WebhookFormProps {
  ...
  onSubmit: (data: { url: string; events: string[]; description?: string }) => Promise<{ secret: string } | undefined>
}

export function WebhookForm({ open, onOpenChange, onSubmit }: WebhookFormProps) {
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-2 p-3 bg-amber-50 rounded-lg text-sm">
              ...
              <p>Use this secret to verify webhook signatures (HMAC-SHA256). It will only be shown once.</p>
            </div>
          </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="url" placeholder="https://your-app.com/webhooks" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="What this webhook is for..." {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
