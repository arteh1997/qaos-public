        ...
        <ScrollReveal>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed mb-16">
              Enterprise tools charge 3-5x more for the same features. Most
              customers save over {tier.symbol}
              {displayPrice} in the first month alone.
            </p>
          </div>
        </ScrollReveal>
            ...
            <div className="relative rounded-3xl border-2 border-primary/30 p-10 lg:p-12 shadow-xl glass gradient-border">
              ...
              <div className="flex flex-col gap-3">
                <Button
                  asChild
                  size="lg"
                  className="w-full text-lg px-8 py-6 h-auto shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/25 transition-all duration-300"
                >
              ...
              <div className="mt-8 rounded-2xl border border-border/60 bg-card p-6 shadow-card">
                ...
                <div className="space-y-3">
                  {VOLUME_DISCOUNTS.map((vd, i) => {
                    ...
                    const savedDisplay = (bill.discount / 100).toLocaleString(
                      tier.locale,
                      { minimumFractionDigits: 0, maximumFractionDigits: 0 },
                    );
                    return (
