...
const features = [
  ...
  },
  {
    ...
    description:
      'Log waste by reason, analyse trends, and get actionable insights to reduce food waste and save money.',
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description:
      'Calculate exact food cost per dish. Analyse margins and identify your most and least profitable menu items.',
  },
  {
    icon: Truck,
  ...
  },
  {
    ...
    description:
      'One dashboard for all your restaurants. Compare performance, benchmark locations, and manage from anywhere.',
  },
  {
    icon: Bell,
    title: 'Smart Alerts',
        ...
        <ScrollReveal>
          <div className="mx-auto max-w-3xl text-center mb-16 lg:mb-20">
            ...
            <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed">
              Powerful features designed by people who understand restaurant operations.
            </p>
          </div>
        </ScrollReveal>
